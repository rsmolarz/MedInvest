...
def api_ai_jobs_create():
    ...
    job = enqueue_ai_job(job_type=job_type, created_by_id=current_user.id, input_text=input_text, post_id=post_id, deal_id=deal_id)
    return jsonify({'status': 'queued', 'job_id': job.id}), 201
